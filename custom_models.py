...
from keras.layers import Conv2D, MaxPool2D, Flatten, Dense, Dropout, AveragePooling2D, BatchNormalization, Activation
...
class LeNet5Custom(tf.keras.Model):
    def __init__(self):
        ...
        self.conv2 = Conv2D(filters=16, kernel_size=(5,5), padding="same", activation="relu")
        self.conv3 = Conv2D(filters=120, kernel_size=(5,5), padding="same", activation="relu")
        self.conv4 = Conv2D(filters=200, kernel_size=(5,5), padding="same", activation="relu")
        self.flatten = Flatten()
        self.fc2 = Dense(units=120, activation="relu")
        self.fc3 = Dense(units=84, activation="relu")
        self.fc4 = Dense(units=43, activation="softmax")
...
class AlexNet(tf.keras.Model):
    ...
    def __init__(self):
        ...
        #creating layers in initializer
        self.conv1 = Conv2D(filters=24, kernel_size=(5,5), strides=(2,2), activation="relu")
        self.max_pool1 = MaxPool2D(pool_size=(3,3), strides=(2,2))
        self.batchnorm1 = BatchNormalization()
        self.conv2 = Conv2D(filters=48, kernel_size=(5,5), padding="same", activation="relu")
        ...
        self.conv5 = Conv2D(filters=48, kernel_size=(3,3), padding="same", activation="relu")
